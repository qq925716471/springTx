...
import springframework.tests.transaction.ITestBean;
import springframework.tests.transaction.TestBean;
import springframework.transaction.MockCallbackPreferringTransactionManager;
 ...
 * @since 16.03.2003
 */
public abstract class AbstractTransactionAspectTests extends TransactionAspectSupport {
	...
	public void enclosingTransactionWithNonTransactionMethodOnAdvisedInside() throws Throwable {
		...
		TestBean outer = new TestBean() {
			...
			public void exceptional(Throwable t) throws Throwable {
				TransactionAspectSupport.TransactionInfo ti = TransactionAspectSupport.currentTransactionInfo();
